...
{
    /// <summary>
    /// GTA3Script GTA Vice City runtime class
    /// </summary>
    public class GTA3ScriptGTAViceCityRuntime : AGTA3ScriptRuntime
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        public GTA3ScriptGTAViceCityRuntime()
        {
            ...
            Patch(0x53D, (runtime, args) =>
            {
                throw new NotImplementedException();
            }, null, "CLEAR_CHAR_WAIT_STATE");
